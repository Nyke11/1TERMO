...
def janela_bemvindo():
    ...
    if nome == "":
        messagebox.showwarning("aviso", "Diite seu nome :)")
    else:
        messagebox.showinfo("Bem-Vindo", f"Olá usuário, {nome} - Seja bem-vindo")
...
lbl_idade = tk.Label(janela, text="Digite seu nome :)")
